...
export class RatiosProcessorService {

    public ratiosExtractorService: RatiosExtractorService;

    public weightConfiguratorService: WeightConfiguratorService;

    public processRatio(): void {
